...
@pytest.fixture
def settings():
    from tutorials.tour.requests_views.models import Settings
...
def registry(settings):
    from tutorials.tour.requests_views import app_bootstrap
...
def test_sample_interactions(registry):
    from tutorials.tour.requests_views import sample_interactions
