...
@pytest.fixture
def settings():
    from tour.context.app import Settings
...
def registry(settings):
    from tour.context.app import setup
...
def default_customer():
    from tour.context.app import Customer
...
@pytest.fixture
def french_customer():
    from tour.context.app import FrenchCustomer

    return FrenchCustomer(name='Henri')


def test_greet_customer(registry, default_customer):
    from tour.context.app import greet_customer
