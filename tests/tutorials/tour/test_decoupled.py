...
@pytest.fixture
def settings():
    from tour.decoupled import Settings
...
def registry(settings):
    from tour.decoupled import setup
...
def default_customer():
    from tour.decoupled import Customer
...
@pytest.fixture
def french_customer():
    from tour.decoupled.custom import FrenchCustomer

    return FrenchCustomer(name='Henri')


def test_greet_customer(registry, default_customer):
    from tour.decoupled import greet_customer
