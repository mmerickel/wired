...
.. literalinclude:: ../../tests/dataclasses/integration/overrides/models.py
    :linenos:
...
.. literalinclude:: ../../tests/dataclasses/integration/overrides/request.py
    :emphasize-lines: 16

To finish, we change our ``assert`` to test two cases:

.. literalinclude:: ../../tests/dataclasses/integration/overrides/test_integration_overrides.py
