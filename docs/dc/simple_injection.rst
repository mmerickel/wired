...
Everything is the same as in :doc:`./decorators`, we just have different models:

.. literalinclude:: ../../tests/dataclasses/integration/simple_injection/models.py
...
.. literalinclude:: ../../tests/dataclasses/integration/simple_injection/test_simple_injection.py
